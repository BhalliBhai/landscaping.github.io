    ...
    $.fn.quovolver = function(options) {
        ...
        return this.each(function() {
            ...
            function buildNav() {
                ...
                if (o.navPrev) {
                    nav.append('<span class="nav-prev"><a href="#"><i class="fas fa-arrow-circle-left"></i></a></span>');
                }
                if (o.navNext) {
                    nav.append('<span class="nav-next"><a href="#"><i class="fas fa-arrow-circle-right"></i></a></span>');
                }
                // Numbered navigation
                if (o.navNum) {
